...
const APP_SHELL_FILES = [
  ...
  "./js/onlineBattleSongSourceUi.js",
  "./js/score.js",
  "./js/timer.js",
  "./js/audio.js",
  "./js/audioDiagnosticLog.js",
  "./js/audioStorage.js",
  "./js/audioPreview.js",
  "./js/audioTroubleClassification.js",
  "./js/audioTroubleRecovery.js",
  "./js/audioTroubleRecoveryFirebase.js",
  "./js/onlineParticipantIcon.js",
  ...
  "./js/debugAudioLogScreen.js",
  "./js/viewportDiagnosticLog.js",
  "./js/lobbyRenderDiagnosticLog.js",
  "./js/lyricsStorage.js",
  "./js/lyricsSync.js",
  "./js/lyricsFullscreen.js",
  "./js/scrollLock.js",
  "./js/viewportMeasurement.js",
  "./js/sfx.js",
  "./js/soundManager.js",
  "./js/soundSettingsScreen.js",
  "./js/quickSfxSettingsPanel.js",
  "./js/highscore.js",
  "./js/screens.js",
  "./js/decorations.js",
  "./js/songlist.js",
  ...
  "./js/instantChallengeQuestionBuilder.js",
  "./js/localReplayCountdown.js",
  ...
  "./js/rankingCandidateAutoSync.js",
  ...
  "./js/partyBattleState.js",
  "./js/partyBattleInput.js",
  "./js/partyBattleVoice.js",
  "./js/partyBattleStorage.js",
  "./js/partyBattleEngine.js",
  "./js/partyBattleScreen.js",
  "./js/songGroupSelectList.js",
  "./js/songGrouping.js",
  "./js/partyBattlePlayScreen.js",
  "./js/songNameMatcher.js",
  "./js/songSearch.js",
  "./js/firebaseClient.js",
  "./js/onlineBattle.js",
  "./js/onlineBattlePresence.js",
  "./js/onlineBattleMatchProgress.js",
  "./js/onlineBattleLobbyReturnPrompt.js",
  "./js/answerConfirmPrompt.js",
  ...
  "./js/onlineBattleMatchConfirmationPayloads.js",
  "./js/onlineBattleCollaborativeSelectionUi.js",
  "./js/onlineBattleResultReturnState.js",
  "./js/onlineBattleRevealTiming.js",
  "./js/onlineBattleStatusTransitionPayloads.js",
  "./js/onlineBattleLeaveMatchPrompt.js",
  "./js/onlineBattleResultLeavePrompt.js",
  "./js/onlineBattleResultHomePrompt.js",
  "./js/onlineInstantBattleScreen.js",
  "./js/instantBattleMatchProgress.js",
  "./js/instantBattleFirebase.js",
  ...
  "./js/lyricsQuizStealClaimTrust.js",
  ...
  "./js/roomInvites.js",
  "./js/roomInviteUi.js",
  "./js/playInvitePayloads.js",
  "./js/playInvites.js",
  "./js/playInviteUi.js",
  "./js/adminConfig.js",
  "./js/adminAccess.js",
  "./js/backupOwnership.js",
  "./js/uidSupersession.js",
  "./js/identityBootstrap.js",
  "./js/uidRepairPlanner.js",
  "./js/adminUidRepair.js",
  "./js/adminUidRepairScreen.js",
  "./js/favoriteSongs.js",
  "./js/playlists.js",
