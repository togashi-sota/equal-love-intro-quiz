...
export const MIX_AND_KOUJOU_GUIDE = [
  ...
  },
  {
    ...
    usageNote:
      "歌唱メンバーの大場花菜が、自身のSHOWROOM配信でファンと一緒に内容を考える「ガチ恋会議」を行い、その後X（旧Twitter）で使ってほしい位置と合わせてファンへ呼びかけたことが確認できます。ファンの間では通常のガチ恋口上とは違う「独自の口上」として案内されており、通常版の亜種と呼ばれることもあります。掛け声本文はメンバー本人が考えた創作性の高い内容のため、この画面には掲載していません（本人がdev/callGuideEditor.htmlから端末に個別に読み込むことは可能です）。",
