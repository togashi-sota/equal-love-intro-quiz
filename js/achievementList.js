...
// 【2026-08-30再改訂・本人指示③→2026-11-XX改訂で表記更新】表示順を①イントロ系②アウトロ系
// ③シャッフル系④リリック系⑤一瞬チャレンジ系（まとめてトロフィー表示、5系統いずれも
// ビギナー〜エースの3段階。一瞬マスターは上のMASTER_TIER_SERIES改訂により他4系統の
// マスターと同じ「マスター称号」専用ブロックへ移したため、ここでは他系統と同じ3段階のまま）
// ⑥マスター称号（イントロ／アウトロ／シャッフル／リリック／一瞬チャレンジの5マスター＋
// ＝LOVEマスター、専用ブロック）⑦裏チャレンジ⑧＝LOVE完全制覇に統一。
