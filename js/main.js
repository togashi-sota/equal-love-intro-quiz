...
initPartyBattleScreens({
  ...
  winnerBurst: document.getElementById("party-result-winner-burst"),
...
initPartyPlayScreen({
  ...
  resultIcon: document.getElementById("party-play-result-icon"),
  resultPlayer: document.getElementById("party-play-result-player"),
  resultPoints: document.getElementById("party-play-result-points"),
  resultSongLabel: document.getElementById("party-play-result-song-label"),
  resultScores: document.getElementById("party-play-result-scores"),
